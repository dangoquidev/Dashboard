		...
		datasets: [
			{
				...
				backgroundColor: ["#0065D8", "#DB1056"],
				borderWidth: 1,
				borderColor: ["#0065D8", "#DB1056"],
				hoverBackgroundColor: ["#0065D8", "#DB1056"],
				hoverBorderColor: ["#0065D8", "#DB1056"],
			},
		],
	};
